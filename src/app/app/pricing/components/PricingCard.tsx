        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
          <div className="relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-default px-8 py-10 shadow-md sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
            ...
            <h2 className="mb-5 text-[42px] font-bold text-foreground">
              {price > 0 ? price.toLocaleString("en-US", { style: "currency", currency: "USD" }) : "Custom"}
              ...
              <span className="absolute right-0 top-7 z-[-1]">
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor={activeWorkspace?.settings?.brandingConfig?.themeColor?.primary ?? "#3056D3"} stopOpacity="0.09" />
                      <stop offset={1} stopColor={activeWorkspace?.settings?.brandingConfig?.themeColor?.secondary ?? "#C4C4C4"} stopOpacity={0} />
                    </linearGradient>
                  </defs>
                </svg>
              </span>
              <span className="absolute right-4 top-4 z-[-1]">
                ...
                >
                  <circle
                    ...
                    fill={activeWorkspace?.settings?.brandingConfig?.themeColor?.primary ?? "#3056D3"}
                  />
                  <circle
                    cx="38.9138"
                    cy="74.9871"
